...
//         // Condition to check if product already exists in the cart.
...
//         <Context.Provider
//             value={{
//                 showCart, setShowCart, totalPrice, totalQuantities, cartItems, qty, incQty, decQty, onAdd, toggleCartItemQuantity
//             }}
//         >
//             {children}
//         </Context.Provider>
...
// // Creating a new context to help us easily grab the state
// export const useStateContext = () => useContext(Context);


// //  We will also be using local storage for the user's data.
